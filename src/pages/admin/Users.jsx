              ...
              <tr key={product.id}>
                ...
                <td className="border-b border-gray-200 px-8 py-10">
                  <button
                    ...
                    className={`relative flex items-center w-28 h-10 rounded-full transition-colors duration-300 ${
                  ...
                  >
                    ...
                    <span
                      className={`absolute w-8 h-8 bg-white rounded-full shadow-md transform transition-transform duration-300 ${
                        isBlocked ? "translate-x-16" : "translate-x-1"
                      }`}
                    ></span>

                    {/* Teks */}
                    <span
                      className={`w-full text-center font-medium transition-colors duration-300 ${
                        isBlocked ? "text-white" : "text-gray-700"
                      }`}
                    >
